...
contract BEP20 is Context, IBEP20, Ownable {
    ...
    uint256 public dexTaxFee = 3; //take fee while sell token to dex
    ...
    constructor(string memory name, string memory symbol) public {
        ...
        IPancakeRouter _router = IPancakeRouter(0xE3105C6fDE037ba2D345bd3D814477f8bAaE3eF9);
...
contract PCMToken is BEP20('pancakemoon Token', 'PCM') {
